...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    if (![[NSUserDefaults standardUserDefaults] boolForKey:MMAlreadyOpenedAddMovie]) {
        [self.window.rootViewController performSegueWithIdentifier:@"addManual" sender:self.window.rootViewController];
    }
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"WatchedData" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"WatchedData.sqlite"];
